...
\begin{cventries}
    ...
    % {Jun, 2023 – Jul, 2023}
    % {\begin{cvitems}
    %   \item {Composed bash script to automate provisioning of infrastructure \& deployment of application for accelerated development efficiency}
    %   \item {Collaborated with the team and configured health checks for 10+ cloud server using Grafana, enabled monitoring of the application}
    %   \end{cvitems}}
    \cventry
    {DevOps Engineer Intern}
    {The Renal Project}
    ...
    % {Dec, 2022 – Jan, 2023}
    % {\begin{cvitems}
    %        \item Designed and implemented authentication API using AWS Cognito, Lambda and Go SDK in an event driven, server-less architecture
    %        \item Engineered a structured schema for 10+ tables using PostgreSQL utilising AWS Lambda to deploy the APIs on server-less architecture
    %   \end{cvitems}}
\end{cventries}
\vspace{-5mm}
